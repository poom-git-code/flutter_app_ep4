...
class UpDetMyTravelUI extends StatefulWidget {
  ...
  UpDetMyTravelUI(
      this.tId, this.tState, this.tImage, this.tNum, this.tDay, this.tPay);

  @override
  _InsertMyTravelState createState() => _InsertMyTravelState();
}

class _InsertMyTravelState extends State<UpDetMyTravelUI> {
                  ...
                  children: [
                    RaisedButton(
                      onPressed: () async {
                        ...
                        Navigator.pop(context);
                        String message = await serviceUpDateTravelDiary(
                            widget.tId,
                            tStateCtrl.text,
                            _selectImageBase64,
                            tNumCtrl.text,
                        ...
                        if(message == '1'){
                          ...
                          _showInsertResultDialog('แก้ไขไม่สำเร็จ');
                        }
                      },
                      color: Colors.orange[300],
                      child: Text(
                  ...
                  children: [
                    RaisedButton(
                      onPressed: () async {
                        ...
                        //ผ่านทาง api ไปที่เราจะสร้าง
                        Navigator.pop(context);
                        String message = await serviceDeleteMyTravel(
                            widget.tId
                        );
                        if(message == '1'){
                          //ถ้าเท่ากับ 1 ให้กลับไปหน้าเเรก
  ...
  void initState() {
    ...
    super.initState();
    tStateCtrl.text = widget.tState;
    tNumCtrl.text = widget.tNum;
    tDayCtrl.text = widget.tDay;
    tPayCtrl.text = widget.tPay;
  }
                ...
                Stack(
                  ...
                  children: [
                    ...
                    _selectImageName == ''
                        ?
                    CachedNetworkImage(
                      imageUrl: '${urlService}/traveldiary/${widget.tImage}',
                      width: 150,
                      height: 150,
                        ...
                        child: RaisedButton(
                          onPressed: (){
                            if(tStateCtrl.text.trim().length == 0){
                              ...
                              _showConfirmDialog('ต้องการเเก้ไขข้อมูลหรือไม่ !!!');
                            }
                          },
                          child: Text(
                            'แก้ไข',
